...
class LinearRegressionModel:
    ...
    #     return X_test,X_train, preprocessor

    def standardized_data(self, X_train, X_test):
    ...
    def train_model(self, X_train, y_train):
        sgd_model = SGDRegressor(loss="squared_error", max_iter=10000, learning_rate="invscaling", eta0=0.01)
...
if __name__ == "__main__":
    ...
    X_train, X_test, preprocessor = model.standardized_data(X_train, X_test)
    sgd_model = model.train_model(X_train, y_train)

    joblib.dump({'model': sgd_model, 'preprocessor': preprocessor}, "linear_regression_model.pkl")